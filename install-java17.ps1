# Java 17 Installation Script for Android Development
# This script will download and install Java 17 (Temurin) automatically

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Java 17 Installation for Android" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not $isAdmin) {
    Write-Host "⚠️  This script needs Administrator privileges to install Java." -ForegroundColor Yellow
    Write-Host ""
    ...
    Write-Host ""
    Write-Host "Or run this command in Admin PowerShell:" -ForegroundColor Cyan
    Write-Host "cd '$PSScriptRoot'; .\install-java17.ps1" -ForegroundColor Green
    Write-Host ""
    pause
    exit
}
...
# Java 17 download URL (Temurin MSI installer)
...
Write-Host "📥 Downloading Java 17 (Temurin)..." -ForegroundColor Cyan
...
try {
    ...
    # Install silently with JAVA_HOME configuration
    ...
    Write-Host "2. Close and reopen your IDE/terminal" -ForegroundColor White
    Write-Host "3. Verify installation: java -version" -ForegroundColor White
    Write-Host "4. Build your Android app!" -ForegroundColor White
    Write-Host ""
    Write-Host "To build Android APK, run:" -ForegroundColor Cyan
    Write-Host "cd android" -ForegroundColor Green
    Write-Host ".\gradlew.bat assembleDebug" -ForegroundColor Green
    Write-Host ""
